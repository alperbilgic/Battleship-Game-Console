...
GPIOPortF_Handler
				...
				LDR		R0, =0x20000004
				LDR		R11,[R0]		;	R11 shows how many times a button is pressed
				ADD		R11, #1
				STR		R11,[R0]
				CMP		R11, #4
				BHI		ileri			; if it is less then or eq. to 4 branch to P1's placement
				BL		buttons
				B		endd
ileri			CMP		R11, #6
				BLS		endd		; if it is 5 or 6 get into white screen and then P2's placement
